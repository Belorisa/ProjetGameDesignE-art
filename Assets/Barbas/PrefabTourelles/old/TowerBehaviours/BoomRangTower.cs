...
public class BoomRangTower : StateTowerLevelUp
{
    public Tower tower;
    ...
    public BoomRangTower(Tower tower) : base(tower)
    {
        this.tower = tower;
    }
        ...
        if (closestTarget != null)
        {
            if (fireTimer <= 0)
            {
                ...
                oui.GetComponent<Bullet>().myStats = new BulletStats(tower.myStats.damages, tower.myStats.bulletSpeed,
                    new BoomRangBullet(oui.GetComponent<Bullet>()), closestTarget);
